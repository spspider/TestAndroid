...
public final class BackgroundService extends Service
{
	 ...
	 * once.
	 */
	private static final Intent REQUEST_REQUERY = new Intent(com.twofortyfouram.locale.api.Intent.ACTION_REQUEST_QUERY);
	...
	static
	{
		 ...
		 */
		//REQUEST_REQUERY.putExtra(com.twofortyfouram.locale.api.Intent.EXTRA_ACTIVITY, EditActivity.class.getName());
	}
