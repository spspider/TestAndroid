...
public class API24 extends XC_MethodHook {
    ...
    protected void beforeHookedMethod(MethodHookParam param) throws Throwable {
        ...
        Sensor s = (Sensor) ((HashMap) XposedHelpers.getObjectField(XposedHelpers.getObjectField(param.thisObject, "mManager"), "mHandleToSensor")).get(Integer.valueOf(((Integer) param.args[0]).intValue()));
