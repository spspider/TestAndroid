...
public class ViewPager extends ViewGroup {
    ...
    private static final Comparator<ItemInfo> COMPARATOR = new C00701();
    ...
    private static final Interpolator sInterpolator = new C00712();
    ...
    private final Runnable mEndScrollRunnable = new C00723();
    ...
    static class C00701 implements Comparator<ItemInfo> {
        C00701() {
        }
    ...
    static class C00712 implements Interpolator {
        C00712() {
        }
