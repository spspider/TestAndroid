...
public final class PlaybackStateCompat implements Parcelable {
    ...
    public static final Creator<PlaybackStateCompat> CREATOR = new C00491();
    ...
    static class C00491 implements Creator<PlaybackStateCompat> {
        C00491() {
        }
    ...
    public static final class CustomAction implements Parcelable {
        public static final Creator<CustomAction> CREATOR = new C00501();
        ...
        static class C00501 implements Creator<CustomAction> {
            C00501() {
            }
