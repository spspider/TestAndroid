...
public class ViewDragHelper {
    ...
    private static final Interpolator sInterpolator = new C01061();
    ...
    private final Runnable mSetIdleRunnable = new C01072();
    private int mTouchSlop;
    private int mTrackingEdges;
    private VelocityTracker mVelocityTracker;

    static class C01061 implements Interpolator {
        C01061() {
        }
