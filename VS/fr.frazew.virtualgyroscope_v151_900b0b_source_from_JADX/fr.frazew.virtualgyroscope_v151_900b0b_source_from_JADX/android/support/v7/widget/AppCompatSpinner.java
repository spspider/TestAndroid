...
public class AppCompatSpinner extends Spinner implements TintableBackgroundView {
    ...
    private class DropdownPopup extends ListPopupWindow {
        ...
        class C01372 implements OnGlobalLayoutListener {
            C01372() {
            }
        ...
        public void show() {
            ...
            if (!wasShowing) {
                ...
                if (vto != null) {
                    final OnGlobalLayoutListener layoutListener = new C01372();
    ...
    public AppCompatSpinner(Context context, int mode) {
        this(context, null, C0120R.attr.spinnerStyle, mode);
    }

    public AppCompatSpinner(Context context, AttributeSet attrs) {
        this(context, attrs, C0120R.attr.spinnerStyle);
    }
    ...
    public AppCompatSpinner(Context context, AttributeSet attrs, int defStyleAttr, int mode, Theme popupTheme) {
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C0120R.styleable.Spinner, defStyleAttr, 0);
        ...
        if (popupTheme != null) {
            ...
            int popupThemeResId = a.getResourceId(C0120R.styleable.Spinner_popupTheme, 0);
        ...
        if (this.mPopupContext != null) {
            ...
            if (mode == 1) {
                ...
                TintTypedArray pa = TintTypedArray.obtainStyledAttributes(this.mPopupContext, attrs, C0120R.styleable.Spinner, defStyleAttr, 0);
                this.mDropDownWidth = pa.getLayoutDimension(C0120R.styleable.Spinner_android_dropDownWidth, -2);
                popup.setBackgroundDrawable(pa.getDrawable(C0120R.styleable.Spinner_android_popupBackground));
                popup.setPromptText(a.getString(C0120R.styleable.Spinner_android_prompt));
                pa.recycle();
                this.mPopup = popup;
