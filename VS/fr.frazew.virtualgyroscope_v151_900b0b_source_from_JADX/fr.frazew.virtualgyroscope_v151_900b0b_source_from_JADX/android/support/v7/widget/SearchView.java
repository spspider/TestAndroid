...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    class C01433 implements Runnable {
        C01433() {
        }
    ...
    class C01444 implements OnFocusChangeListener {
        C01444() {
        }
    ...
    class C01455 implements OnLayoutChangeListener {
        C01455() {
        }
    ...
    class C01466 implements OnGlobalLayoutListener {
        C01466() {
        }
    ...
    class C01477 implements OnClickListener {
        C01477() {
        }
    ...
    class C01488 implements OnKeyListener {
        C01488() {
        }
    ...
    class C01499 implements OnEditorActionListener {
        C01499() {
        }
    ...
    public static class SearchAutoComplete extends AppCompatAutoCompleteTextView {
        ...
        public SearchAutoComplete(Context context, AttributeSet attrs) {
            this(context, attrs, C0120R.attr.autoCompleteTextViewStyle);
        }
    ...
    public SearchView(Context context, AttributeSet attrs) {
        this(context, attrs, C0120R.attr.searchViewStyle);
    }

    public SearchView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        this.mShowImeRunnable = new C01411();
        this.mUpdateDrawableStateRunnable = new C01422();
        this.mReleaseCursorRunnable = new C01433();
        this.mOutsideDrawablesCache = new WeakHashMap();
        this.mOnClickListener = new C01477();
        this.mTextKeyListener = new C01488();
        this.mOnEditorActionListener = new C01499();
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C0120R.styleable.SearchView, defStyleAttr, 0);
        this.mTintManager = a.getTintManager();
        LayoutInflater.from(context).inflate(a.getResourceId(C0120R.styleable.SearchView_layout, C0120R.layout.abc_search_view), this, true);
        ...
        this.mSearchPlate.setBackgroundDrawable(a.getDrawable(C0120R.styleable.SearchView_queryBackground));
        this.mSubmitArea.setBackgroundDrawable(a.getDrawable(C0120R.styleable.SearchView_submitBackground));
        this.mSearchButton.setImageDrawable(a.getDrawable(C0120R.styleable.SearchView_searchIcon));
        this.mGoButton.setImageDrawable(a.getDrawable(C0120R.styleable.SearchView_goIcon));
        this.mCloseButton.setImageDrawable(a.getDrawable(C0120R.styleable.SearchView_closeIcon));
        this.mVoiceButton.setImageDrawable(a.getDrawable(C0120R.styleable.SearchView_voiceIcon));
        this.mCollapsedIcon.setImageDrawable(a.getDrawable(C0120R.styleable.SearchView_searchIcon));
        this.mSearchHintIcon = a.getDrawable(C0120R.styleable.SearchView_searchHintIcon);
        this.mSuggestionRowLayout = a.getResourceId(C0120R.styleable.SearchView_suggestionRowLayout, C0120R.layout.abc_search_dropdown_item_icons_2line);
        this.mSuggestionCommitIconResId = a.getResourceId(C0120R.styleable.SearchView_commitIcon, 0);
        ...
        this.mSearchSrcTextView.setOnFocusChangeListener(new C01444());
        setIconifiedByDefault(a.getBoolean(C0120R.styleable.SearchView_iconifiedByDefault, true));
        int maxWidth = a.getDimensionPixelSize(C0120R.styleable.SearchView_android_maxWidth, -1);
        if (maxWidth != -1) {
            setMaxWidth(maxWidth);
        }
        this.mDefaultQueryHint = a.getText(C0120R.styleable.SearchView_defaultQueryHint);
        this.mQueryHint = a.getText(C0120R.styleable.SearchView_queryHint);
        int imeOptions = a.getInt(C0120R.styleable.SearchView_android_imeOptions, -1);
        if (imeOptions != -1) {
            setImeOptions(imeOptions);
        }
        int inputType = a.getInt(C0120R.styleable.SearchView_android_inputType, -1);
        if (inputType != -1) {
            setInputType(inputType);
        }
        setFocusable(a.getBoolean(C0120R.styleable.SearchView_android_focusable, true));
        a.recycle();
    ...
    private void addOnLayoutChangeListenerToDropDownAnchorSDK11() {
        this.mDropDownAnchor.addOnLayoutChangeListener(new C01455());
    }

    private void addOnLayoutChangeListenerToDropDownAnchorBase() {
        this.mDropDownAnchor.getViewTreeObserver().addOnGlobalLayoutListener(new C01466());
    }
    ...
    private void adjustDropDownSizeAndPosition() {
        if (this.mDropDownAnchor.getWidth() > 1) {
            ...
            int iconOffset = this.mIconifiedByDefault ? res.getDimensionPixelSize(C0120R.dimen.abc_dropdownitem_icon_width) + res.getDimensionPixelSize(C0120R.dimen.abc_dropdownitem_text_padding_left) : 0;
