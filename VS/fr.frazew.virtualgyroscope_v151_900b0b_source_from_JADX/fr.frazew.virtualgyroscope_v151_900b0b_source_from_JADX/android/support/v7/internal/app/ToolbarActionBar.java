...
public class ToolbarActionBar extends ActionBar {
    ...
    private final OnMenuItemClickListener mMenuClicker = new C01952();
    private final Runnable mMenuInvalidator = new C01211();
    ...
    class C01952 implements OnMenuItemClickListener {
        C01952() {
        }
...
*/
    ...
    private void ensureListMenuPresenter(Menu menu) {
        if (this.mListMenuPresenter == null && (menu instanceof MenuBuilder)) {
            ...
            this.mListMenuPresenter = new ListMenuPresenter(context2, C0120R.layout.abc_list_menu_item_layout);
