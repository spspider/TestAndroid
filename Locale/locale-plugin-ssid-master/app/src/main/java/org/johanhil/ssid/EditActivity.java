...
public final class EditActivity extends Activity
{
	...
	public void onCreate(final Bundle savedInstanceState)
	{
		 ...
		 */
		final String breadcrumbString = getIntent().getStringExtra(com.twofortyfouram.locale.api.Intent.EXTRA_STRING_BREADCRUMB);
		//if (breadcrumbString != null)
			//setTitle(String.format("%s%s%s", breadcrumbString, com.twofortyfouram.locale.api.Intent.BREADCRUMB_SEPARATOR, getString(R.string.plugin_name))); //$NON-NLS-1$
		...
		{
			final Bundle forwardedBundle = getIntent().getBundleExtra(com.twofortyfouram.locale.api.Intent.EXTRA_BUNDLE);
	...
	public void finish()
	{
		...
		else
		{
			...
			else
			{
				...
				returnIntent.putExtra(com.twofortyfouram.locale.api.Intent.EXTRA_STRING_BLURB, SSID);
