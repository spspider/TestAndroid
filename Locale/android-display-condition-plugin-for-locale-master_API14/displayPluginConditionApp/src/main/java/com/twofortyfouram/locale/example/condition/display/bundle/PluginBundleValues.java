...
public final class PluginBundleValues {
    ...
    private static final String BUNDLE_EXTRA_StringReturn = "com.twofortyfouram.locale.example.condition.display.extra.StringReturn";;
    /**
     * Type: {@code int}.
     * <p>
    ...
    public static String StringReturn(@NonNull final Bundle bundle) {
        return bundle.getString(BUNDLE_EXTRA_StringReturn);
    }
    /**
