...
public class MQTT_Service_depricated extends Service implements MqttCallback
{
    ...
    private static String MQTT_BROKER = "m20.cloudmqtt.com"; // Broker URL or IP Address
    private static int MQTT_PORT = 16238; // Broker Port
    private static String username = "spspider";
    private static String password = "5506487";
        ...
        mConnHandler.post(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    mClient.subscribe(subscribe_text_first_connect, 0);

                    mClient.setCallback(new MqttEventCallback(MainActivity.getInstance().getContext()));
