...
public class MotionDetectionActivity extends SensorsActivity {
    ...
    static final String TAG = "MotionDetectionActivity";
    ...
    private PreviewCallback previewCallback = new PreviewCallback() {
        ...
        public void onPreviewFrame(byte[] data, Camera cam) {
            ...
            if (!GlobalData.isPhoneInMotion()) {
                DetectionThread thread = new DetectionThread(data, size.width, size.height,getApplication().getApplicationContext());
                thread.start();
            }
        }
    };
    ...
    private static final class DetectionThread extends Thread {
        ...
        public DetectionThread(byte[] data, int width, int height, Context applicationContext) {
            this.data = data;
            this.width = width;
            this.height = height;
        ...
        public void run() {
            ...
            try {
                ...
                if (img != null && detector.detect(img, width, height)) {
                    ...
                    Vibrate VB=new Vibrate();
                        VB.vibration(MotionDetectionActivity.getActivity());
