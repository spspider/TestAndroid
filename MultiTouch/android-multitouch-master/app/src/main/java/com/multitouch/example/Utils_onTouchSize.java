    ...
    public View.OnTouchListener touchListener2=(new View.OnTouchListener(){
        ...
        public boolean onTouch(View v, MotionEvent event) {
            ...
            if (v instanceof RadioButton){
                ...
                float scale=1;
                if (new_size<30.0){new_size=30;scale=new_size/prevscaleRbtn+0.1f;matrixRb.setScale(scale, scale, mid.x, mid.y);}
                if (new_size>80.0){new_size=80;scale=new_size/prevscaleRbtn-0.1f;matrixRb.setScale(scale, scale, mid.x, mid.y);}
                ArrayList<RadioButton> radios = new ArrayList<>();
                ...
                float scale=1;
                if (new_size<30.0){new_size=30;scale=new_size/prevscale+0.1f;matrix.setScale(scale, scale, mid.x, mid.y);}
                if (new_size>80.0){new_size=80;scale=new_size/prevscale-0.1f;matrix.setScale(scale, scale, mid.x, mid.y);}
                tview.setTextSize(COMPLEX_UNIT_PX, new_size);
            }
