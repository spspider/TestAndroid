...
public class MQTTservice extends Service
{
	...
	private class MQTTConnection extends Thread
	{
		...
		private class MsgHandler extends Handler implements MqttCallback
		{
			...
			MsgHandler(String uri)
			{
				options.setCleanSession(true);
				options.setUserName("spspider");
				options.setPassword(("5506487").toCharArray());
				...
				try
				{
					...
					client = new MqttClient(uri, myClientID, null);
			...
			public void messageArrived(String topic, MqttMessage message) throws Exception
			{
				...
				if (intentName != null)
				{
					Log.d("messageArrived", "intentName is not null");
					...
					Log.d("messageArrived", "intentName is null");
				...
				.setContentText("msg arrived from <" + topic + ">" )
